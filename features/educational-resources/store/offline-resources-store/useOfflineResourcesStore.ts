...
import { useResourcesSelectionStore } from "../resources-selection-store/useResourceSelectionStore";

export const useOfflineResourcesStore = create<OfflineResourcesStoreType>(
  (set) => ({
    isProcessing: false,
    isLoading: false,
    isSharing: false,
