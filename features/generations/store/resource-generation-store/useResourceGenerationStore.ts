...
import { useGenerationsSelectionStore } from "../generations-selection-store/useGenerationsSelectionStore";
...
export const useResourceGenerationStore = create<ResourceGenerationStoreType>()(
  persist<ResourceGenerationStoreType, [], [], GenerationStorePersistedState>(
    (set, get) => ({
      ...
      reinitSelectedGenerations: (): void => {
        ...
        const updated = selectedGenerations.map((generation) => {
