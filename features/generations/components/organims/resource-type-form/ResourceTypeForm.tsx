  ...
  return (
    <>
      <PopUp
        ...
        isOpen={chooseResourceTypePopUp.isOpen}
        onClose={chooseResourceTypePopUp.closePopUp}
      >
        <DropdownOptionList<ResourceType>
          ...
          onSelectOption={(option) => {
            ...
            chooseResourceTypePopUp.closePopUp();
          }}
        />
      </PopUp>
      <Form>
          ...
          >
            <Form.Row.Item span={1}>
              <Form.Dropdown<ResourceTypeFormData, ResourceType>
                ...
                displayDropdownOptions={chooseResourceTypePopUp.openPopUp}
