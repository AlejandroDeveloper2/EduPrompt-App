...
export const ErrorMessages = {
  ...
  CREATE_ORDER_ERROR: i18n.t("server-error-messages.create-order-error-msg"),
  CAPTURE_ORDER_ERROR: i18n.t("server-error-messages.capture-order-error-msg"),
  GET_ORDER_ERROR: i18n.t("server-error-messages.get-order-error-msg"),
  ORDER_NOT_FOUND: i18n.t("server-error-messages.order-not-found-msg"),
  SUBSCRIPTION_NOT_FOUND: i18n.t(
    "server-error-messages.subscription-not-found-msg",
  ),
  SUBSCRIPTION_HISTORY_ITEM_NOT_FOUND: i18n.t(
    "server-error-messages.subscription-history-item-not-found-msg",
  ),
  SUBSCRIPTION_CREATION_ERROR: i18n.t(
    "server-error-messages.subscription-creation-error-msg",
  ),
  AUTH_REQUIRED: i18n.t("server-error-messages.auth-required-msg"),
};
